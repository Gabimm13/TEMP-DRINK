...
#define FIREBASE_AUTH "SnxHQS0jDmj8ZpHM6EqiaNBqKSYnJEzKPB7IVo7L"
#define WIFI_SSID "Gabys_room"
#define WIFI_PASSWORD "F82DC014EAE4"
...
void handleIndex(){ 
String Website = "<!DOCTYPE HTML>\r\n \r\n<html><head><title>Lectura de temperatura</title><meta http-equiv=\"refresh\" content=\"2\"></head><body > <h1>Temp-Drink: </h1> La temperatura de la bebida es de : "+ String(temperatureC)+"*C<br> </body></html>\n";
server.send(200,"text/html",Website); // we'll need to refresh the page for getting the lastest value //S1
 ...
 /* s += "\r\n<html><head><meta http-equiv=\"refresh\" content=\"2\"></head><body>\r\n";
  s += "<h2>Temperatura: </h2>";
  s += "Temperatura: "+ String(temperatureC)+"*C<br>";
  s += "</body></html>\n";*/
...
void loop() {
 ...
 server.handleClient();
  ...
  String path = "/Test";
  json.set("Gabriela Mejia" + String(1), temperatureC);
